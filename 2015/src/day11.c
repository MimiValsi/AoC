...
void check_string(char *puzzle, uint32_t len, int32_t i);
bool straight_three_letters(char *puzzle, uint32_t len);
bool no_i_o_l(char *puzzle, uint32_t len);
bool overlap(char *puzzle, uint32_t len);
